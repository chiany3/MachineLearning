...
TRAIN_PROCESSED_FILE = '/content/drive/MyDrive/FX_ML/Twitter-Sentiment-Analysis-main/dataset/train-processed.csv'
TEST_PROCESSED_FILE = '/content/drive/MyDrive/FX_ML/Twitter-Sentiment-Analysis-main/dataset/test-processed.csv'
POSITIVE_WORDS_FILE = '/content/drive/MyDrive/FX_ML/Twitter-Sentiment-Analysis-main/dataset/positive-words.txt'
NEGATIVE_WORDS_FILE = '/content/drive/MyDrive/FX_ML/Twitter-Sentiment-Analysis-main/dataset/negative-words.txt'
TRAIN = True
